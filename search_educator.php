...
<section class="educators">
   ...
   <h1 class="heading">expert educators</h1>

   <form action="" method="post" class="search-educator">
   ...
   <div class="box-container">
      ...
      <?php
         if(isset($_POST['search_educator']) or isset($_POST['search_educator_btn'])){
            $search_educator = $_POST['search_educator'];
            $select_educators = $conn->prepare("SELECT * FROM `educators` WHERE name LIKE '%{$search_educator}%'");
