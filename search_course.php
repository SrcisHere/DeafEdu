...
<section class="courses">
   ...
   <h1 class="heading">search course results</h1>
...
<!-- note_courses section starts  -->

<section class="notecourses">

   <h1 class="heading">search note results</h1>

   <div class="box-container">

      <?php
         if(isset($_POST['search_course']) or isset($_POST['search_course_btn'])){
         $search_notecourse = $_POST['search_course'];
         $select_notecourses = $conn->prepare("SELECT * FROM `library` WHERE title LIKE '%{$search_course}%' AND status = ?");
      ...
      <?php
         ...
         echo '<p class="empty">no notes found!</p>';
      }
      }else{
         echo '<p class="empty">please search something!</p>';
      }
