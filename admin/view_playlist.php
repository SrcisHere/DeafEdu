...
<section class="playlist-details">
   ...
   <?php
      $select_playlist = $conn->prepare("SELECT * FROM `playlist` WHERE id = ? AND educator_id = ?");
      $select_playlist->execute([$get_id, $educator_id]);
...
<section class="contents">
   ...
   <?php
      $select_videos = $conn->prepare("SELECT * FROM `content` WHERE educator_id = ? AND playlist_id = ?");
      $select_videos->execute([$educator_id, $playlist_id]);
