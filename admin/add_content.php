...
if(isset($_POST['submit'])){
   ...
   if($thumb_size > 2000000){
      ...
      $add_playlist = $conn->prepare("INSERT INTO `content`(id, educator_id, playlist_id, title, description, video, thumb, status) VALUES(?,?,?,?,?,?,?,?)");
      $add_playlist->execute([$id, $educator_id, $playlist, $title, $description, $rename_video, $rename_thumb, $status]);
