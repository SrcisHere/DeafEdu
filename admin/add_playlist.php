...
if(isset($_POST['submit'])){
   ...
   $add_playlist = $conn->prepare("INSERT INTO `playlist`(id, educator_id, title, description, thumb, status) VALUES(?,?,?,?,?,?)");
   $add_playlist->execute([$id, $educator_id, $title, $description, $rename, $status]);
